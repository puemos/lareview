...
impl Default for AgentRegistry {
    fn default() -> Self {
        ...
        registry.register_agent(Box::new(crate::acp::agents::codex::CodexAgent));
        registry.register_agent(Box::new(crate::acp::agents::gemini::GeminiAgent));
        registry.register_agent(Box::new(crate::acp::agents::qwen::QwenAgent));
        registry.register_agent(Box::new(crate::acp::agents::mistral::MistralAgent));
